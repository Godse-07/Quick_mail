<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting-Pushan.aspx.cs" Inherits="GMAIL_CLONE.Seting_Pushan" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="pushan-setting.css">
     <style type="text/css">
...
<td>
                <asp:Button ID="Button1" runat="server" Text="Logout" CssClass="bt" OnClick="Button1_Click1" 
                     />
            </td>
        </tr>
        </table>
        ...
        <td>
           ...
           <td>
               <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="mail-setting.png" 
                   Height="50px" Width="60px" OnClick="ImageButton4_Click1" /><br />
               &nbsp;
...
<div class="b">
    ...
    <asp:FileUpload ID="FileUpload2" runat="server" onchange="displayImage(this);"/><br /><br />
    <!--<asp:Button ID="Button3" runat="server" Text="Confirm picture!"  />-->
    <br /><br />
