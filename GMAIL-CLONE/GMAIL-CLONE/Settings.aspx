...
<body>
    ...
    <div id="x">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="grid">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:ImageField DataImageUrlField="to_imgurl" HeaderText="Image">
                    <ControlStyle Height="55px" Width="60px" />
                </asp:ImageField>
                <asp:BoundField DataField="to_email" HeaderText="Email_id" />
                <asp:TemplateField HeaderText="Title">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("title") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                    <a id="A2" href='<%# "Sent.aspx?msgid="+Eval("msg_id") %>' runat="server">
